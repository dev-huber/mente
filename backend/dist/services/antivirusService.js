...
exports.antivirusService = exports.AntivirusService = void 0;
...
class AntivirusService {
    ...
    constructor(config = {
        ...
        this.config = config;
        this.logger = (0, logger_1.createLogger)('AntivirusService');
    }
    /**
    ...
    async scanFile(fileData) {
        ...
        try {
            ...
            const result = this.createScanResult(overallClean, threats.length > 0 ? threats.join(', ') : undefined, confidence, startTime, {
     ...
     */
    validateBasicProperties(fileData) {
        // Size validation
     ...
     */
    validateFileSignature(fileData) {
        ...
        const hasValidSignature = expectedSignatures.some(sig => header.startsWith(sig.toLowerCase()));
     ...
     */
    analyzeContentPatterns(fileData) {
        const threats = [];
     ...
     */
    async performExternalScan(fileData) {
     ...
     */
    createScanResult(clean, threat, confidence, startTime, details) {
        return {
            clean,
            threat,
            confidence,
...
exports.antivirusService = new AntivirusService();
